...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), '2019-11-16');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Willis'), '2019-11-16');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'P3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Rivera'), '2019-11-16');
